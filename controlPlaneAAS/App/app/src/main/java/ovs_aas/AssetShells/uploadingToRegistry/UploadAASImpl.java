...
package ovs_aas.AssetShells.uploadingToRegistry;
...
public class UploadAASImpl implements UploadAAS {
    ...
    private String generateAASIP(Integer port) {
        System.out.println("Indirizzo: " + "http://" + StaticProperties.getAAS_IP() + "/aas");
        return String.format("http://" + StaticProperties.getAAS_IP() + "/aas");
    }
}