...
public class SSHManager {
     ...
     */
    public String executeSingleCommand(String command, String host, int sshPort) {
        ChannelExec ch = (ChannelExec) this.channelInit("exec", host, sshPort);
     ...
     */
    public Channel channelInit(String type, String sshHost, int sshPort) {
        Channel channel = null;
        try {
            Session session = this.setupSshSession(sshHost, sshPort);
     ...
     */
    private Session setupSshSession(String SSH_HOST, int SSH_PORT) {
