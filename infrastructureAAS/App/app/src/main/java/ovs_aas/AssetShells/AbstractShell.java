...
import ovs_aas.AssetShells.uploadingToRegistry.UploadAAS;
import ovs_aas.AssetShells.uploadingToRegistry.UploadAASImpl;
...
public abstract class AbstractShell implements IShell {
    ...
    public void createDescriptors() {
        this.descriptorsManager = new UploadAASImpl(StaticProperties.get_REGISTRY_PATH());
