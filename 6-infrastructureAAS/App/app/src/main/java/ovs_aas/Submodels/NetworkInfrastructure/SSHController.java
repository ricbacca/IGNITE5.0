...
public class SSHController {
    ...
    public SSHController() {
        controllerChannels.put(1, sshManager.channelInit("shell", StaticProperties.getCNT1_IP(), StaticProperties.getCNT1_SSH()));
        controllerChannels.put(2, sshManager.channelInit("shell", StaticProperties.getCNT2_IP(), StaticProperties.getCNT2_SSH()));
    ...
    private void killController() {
        sshManager.executeSingleCommand(KILL_RYU, StaticProperties.getCNT1_IP(), StaticProperties.getCNT1_SSH());
        sshManager.executeSingleCommand(KILL_RYU, StaticProperties.getCNT2_IP(), StaticProperties.getCNT2_SSH());
    }
}